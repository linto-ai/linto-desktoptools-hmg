...
class Ui_Export(object):
    def setupUi(self, Export):
        ...
        self.TFLite_PB.setEnabled(False)
        self.TFLite_PB.setObjectName("TFLite_PB")
        self.horizontalLayout_5.addWidget(self.TFLite_PB)
        self.TFLITE_BI_CB = QtWidgets.QCheckBox(Export)
        self.TFLITE_BI_CB.setEnabled(False)
        self.TFLITE_BI_CB.setChecked(True)
        self.TFLITE_BI_CB.setObjectName("TFLITE_BI_CB")
        self.horizontalLayout_5.addWidget(self.TFLITE_BI_CB)
        self.SEL_OPS_CB = QtWidgets.QCheckBox(Export)
        self.SEL_OPS_CB.setEnabled(False)
        self.SEL_OPS_CB.setObjectName("SEL_OPS_CB")
        self.horizontalLayout_5.addWidget(self.SEL_OPS_CB)
    ...
    def retranslateUi(self, Export):
        ...
        self.TFLITE_BI_CB.setText(_translate("Export", "TFLITE_BUILTINS"))
        self.SEL_OPS_CB.setText(_translate("Export", "SELECT_TF_OPS"))
