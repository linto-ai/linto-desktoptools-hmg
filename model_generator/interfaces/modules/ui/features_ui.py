...
class Ui_Features(object):
    def setupUi(self, Features):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.chart_Widget)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.widget = QtWidgets.QWidget(self.chart_Widget)
        ...
        self.dataSet_CB = QtWidgets.QComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dataSet_CB.sizePolicy().hasHeightForWidth())
        self.dataSet_CB.setSizePolicy(sizePolicy)
        self.dataSet_CB.setObjectName("dataSet_CB")
        self.horizontalLayout_11.addWidget(self.dataSet_CB)
        self.variance_CB = QtWidgets.QCheckBox(self.widget)
        self.variance_CB.setObjectName("variance_CB")
        self.horizontalLayout_11.addWidget(self.variance_CB)
        self.analyse_PB = QtWidgets.QPushButton(self.widget)
        self.analyse_PB.setObjectName("analyse_PB")
        self.horizontalLayout_11.addWidget(self.analyse_PB)
    ...
    def retranslateUi(self, Features):
        ...
        self.variance_CB.setText(_translate("Features", "Display Variance"))
        self.analyse_PB.setText(_translate("Features", "Analyse"))
