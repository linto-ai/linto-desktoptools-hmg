...
class Ui_Features(object):
    def setupUi(self, Form):
        ...
        self.audio_parameters = QtWidgets.QGroupBox(Form)
        ...
        self.preprocess = QtWidgets.QGroupBox(Form)
        ...
        self.windows = QtWidgets.QGroupBox(Form)
        ...
        self.feature_Widget = QtWidgets.QWidget(Form)
        ...
        self.chart_Widget = QtWidgets.QWidget(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.output_row_LCD = QtWidgets.QLCDNumber(Form)
        ...
        self.output_col_LCD = QtWidgets.QLCDNumber(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "Feature Profile"))
        self.create_PB.setText(_translate("Form", "Create Profile"))
        self.delete_PB.setText(_translate("Form", "Delete Profile"))
        self.audio_parameters.setTitle(_translate("Form", "Sample Parameters"))
        self.label_15.setText(_translate("Form", "Sample Rate"))
        self.sample_rate.setToolTip(_translate("Form", "<html><head/><body><p>Samples\'s sampling rate.</p></body></html>"))
        self.sample_rate.setSuffix(_translate("Form", "Hz"))
        self.label_17.setText(_translate("Form", "Encoding"))
        self.encoding.setToolTip(_translate("Form", "<html><head/><body><p>Sample encoding</p></body></html>"))
        self.encoding.setSuffix(_translate("Form", "B"))
        self.label_16.setText(_translate("Form", "Sample length"))
        self.sample_t.setToolTip(_translate("Form", "<html><head/><body><p>Expected sample duration.</p><p>Samples longer will be trimmed.</p><p>Sample shorter will be ignored.</p></body></html>"))
        self.sample_t.setSuffix(_translate("Form", "s"))
        self.preprocess.setTitle(_translate("Form", "Pre-processing"))
        self.preEmp_CB.setText(_translate("Form", "PreEmphasis"))
        self.preEmp_SB.setToolTip(_translate("Form", "<html><head/><body><p>PreEmphasis factor</p></body></html>"))
        self.windows.setTitle(_translate("Form", "Windows Parameters"))
        self.label.setText(_translate("Form", "Window length"))
        self.window_t_SP.setToolTip(_translate("Form", "<html><head/><body><p>Analysis window length</p></body></html>"))
        self.window_t_SP.setSuffix(_translate("Form", "s"))
        self.label_2.setText(_translate("Form", "Stride"))
        self.stride_t_SB.setToolTip(_translate("Form", "<html><head/><body><p>Analysis window stride</p></body></html>"))
        self.stride_t_SB.setSuffix(_translate("Form", "s"))
        self.label_3.setText(_translate("Form", "Window function"))
        self.window_fun_CoB.setToolTip(_translate("Form", "<html><head/><body><p>Window function to be applied.</p><p>Some features extraction process may have their own</p><p>window function.</p></body></html>"))
        self.window_fun_CoB.setItemText(0, _translate("Form", "none"))
        self.window_fun_CoB.setItemText(1, _translate("Form", "hamming"))
        self.window_fun_CoB.setItemText(2, _translate("Form", "hanning"))
        self.window_fun_CoB.setItemText(3, _translate("Form", "bark"))
        self.label_5.setText(_translate("Form", "Ouput_size:"))
        self.output_row_LCD.setToolTip(_translate("Form", "<html><head/><body><p>Output vector number of row.</p></body></html>"))
        self.label_6.setText(_translate("Form", "x"))
        self.output_col_LCD.setToolTip(_translate("Form", "<html><head/><body><p>Output vector number of parameters.</p></body></html>"))
        self.save_PB.setText(_translate("Form", "Save Parameters"))
